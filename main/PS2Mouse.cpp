...
int PS2Mouse::clock_pin(void)
{
	return (_clock_pin);
}

int PS2Mouse::data_pin(void)
{
	return (_data_pin);
}

void PS2Mouse::initialize(void)
{
...
void PS2Mouse::set_remote_mode(void)
{
	set_mode(0xf0);
	_mode = REMOTE;
}

void PS2Mouse::set_stream_mode(void)
{
	set_mode(0xea);
	_mode = STREAM;
}
...
void PS2Mouse::disable_data_reporting(void)
{
	if (_disabled)
		return;
...
int PS2Mouse::read(void)
{
	return (read_byte());
}

int8_t PS2Mouse::read_byte(void)
{
	int8_t data = 0;
	pull_high(_clock_pin);
	pull_high(_data_pin);
